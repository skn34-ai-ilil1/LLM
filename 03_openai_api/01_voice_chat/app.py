...
def main():
    ...
    if 'messages' not in st.session_state:  # 대화 히스토리가 없으면 system 메세지 초기화
        st.session_state['messages'] = [{'role' : 'system', 'content' : system_prompt}]
    if 'check_reset' not in st.session_state:   # 초기화 여부
