...
MATCH path = (student:Student)-[enroll:ENROLLED_IN]->(course:Course)
RETURN path
ORDER BY student.student_id, course.course_id;

MATCH path = (student:Student)-[relation:ENROLLED_IN]->(course:Course)
RETURN path
ORDER BY student, relation, course;
